...
---
= StorageGRID 에 그리드 노드 또는 새 사이트를 추가하는 워크플로 요약
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.단계
. link:updating-subnets-for-grid-network.html["그리드 네트워크의 서브넷을 업데이트합니다."].
. link:deploying-new-grid-nodes.html["새로운 그리드 노드를 배포합니다."].

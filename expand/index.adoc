...
---
= StorageGRID 시스템 확장 방법에 대해 알아보세요.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
운영 중단 없이 StorageGRID 시스템의 용량이나 기능을 확장하는 방법에 대해 알아보세요. 기존 스토리지 노드에 스토리지 볼륨을 추가하거나, 기존 사이트에 새 그리드 노드를 추가하거나, 새 사이트를 추가할 수 있습니다.

...
image:ilm_replication_make_1_copy.png["ILM 복제 1개 복사본"]
...
image:ilm_replication_make_1_copy_sn_fails.png["ILM 복제 1개 복제 SN에 장애가 발생합니다"]
...
image:ilm_replication_make_2_copies_sn_fails.png["ILM 복제 2개 복사본 SN에 장애가 발생합니다"]

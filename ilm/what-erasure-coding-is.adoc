...
image:ec_three_sites_4_plus_2.png["삭제 코딩 3개 사이트 4 Plus 2"]
...
image:ec_recoverable_4_plus_2.png["삭제 코딩 복구 가능 4 Plus 2"]

두 개 이상의 스토리지 노드가 손실되면 객체를 검색할 수 없습니다.

image:ec_unrecoverable_4_plus_2.png["삭제 코딩 복구할 수 없는 4 Plus 2"]

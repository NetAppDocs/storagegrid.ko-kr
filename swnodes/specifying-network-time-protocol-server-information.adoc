...
summary: 'StorageGRID 시스템에 대해 NTP(네트워크 시간 프로토콜) 구성 정보를 지정해야 별도의 서버에서 수행되는 작업을 동기화할 수 있습니다.' 
---
= StorageGRID에 대한 Network Time Protocol 서버 정보 지정
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image:8_gmi_installer_ntp_page.gif["이 이미지는 주변 텍스트로 설명됩니다."]

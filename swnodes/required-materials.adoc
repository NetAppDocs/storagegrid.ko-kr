...
--
노드 마이그레이션(필요한 경우 Ubuntu 및 Debian만 해당):: link:node-container-migration-requirements.html["노드 마이그레이션에 대한 요구사항"]서비스 중단 없이 물리적 호스트에 대해 예약된 유지 관리를 수행하려는 경우 을 이해합니다.
...
+
--
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["릴리스 정보"^]. 릴리스 노트에 액세스하려면 NetApp 계정으로 로그인하거나 계정을 생성해야 합니다.

...
image:rhel_node_configuration_file_output.gif["이 이미지는 주변 텍스트로 설명됩니다."]
...
image:rhel_node_configuration_file_output_with_errors.gif["이 이미지는 주변 텍스트로 설명됩니다."]

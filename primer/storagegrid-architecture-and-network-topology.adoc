...
image:data_center_site_single.png["단일 데이터 센터 사이트"]
...
image:data_center_sites_multiple.png["다중 데이터 센터 사이트"]
...
image:grid_nodes_and_components.png["주변 텍스트로 설명하는 다이어그램"]

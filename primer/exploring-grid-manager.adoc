...
image:grid_manager_dashboard_and_menu.png["그리드 관리자의 대시보드"]

각 카드에 표시된 정보에 대한 설명을 보려면 해당 카드의 도움말 아이콘 image:icon_nms_question.png["물음표 아이콘"]을 선택하십시오.
...
도움말 메뉴 image:icon-help-menu-bar.png["메뉴 모음의 도움말 아이콘"]를 통해 다음 항목에 액세스할 수 있습니다.

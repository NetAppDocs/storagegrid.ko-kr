...
summary: StorageGRID 12.0은 객체 스토리지 용량을 확장하고, AI/ML 워크로드 지원을 개선하며, 그리드 연합을 강화하고, 시스템 관리를 간소화하며, 플랫폼 전반의 보안을 강화합니다. 
---
...
[role="lead"]
StorageGRID 12.0은 객체 스토리지 용량을 확장하고, AI/ML 워크로드 지원을 개선하며, 그리드 연합을 강화하고, 시스템 관리를 간소화하며, 플랫폼 전반의 보안을 강화합니다.

최근 StorageGRID 12.0 릴리스의 수정된 문제 및 알려진 문제에 대한 자세한 내용은 https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["StorageGRID 12.0 릴리스 노트"^]를 참조하십시오. 릴리스 노트에 액세스하려면 NetApp 계정으로 로그인하거나 계정을 생성해야 합니다.

...
---
= StorageGRID 어플라이언스 스토리지 노드를 구성하려면 복구 시작을 선택하십시오
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. 복구 시작 * 을 클릭합니다.
+
image:4b_select_recovery_node.png["유지 관리 > 복구 페이지를 보여주는 스크린샷"]
...
+
image:recovery_reset_button.gif["수동 단계를 기다리는 단계를 보여 주는 스크린샷"]
...
+
image:recovery_reset_warning.gif["복구 경고 재설정 대화 상자를 보여 주는 스크린샷"]

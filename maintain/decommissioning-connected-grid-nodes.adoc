...
* 모든 그리드 노드의 상태가 정상(녹색)입니다 image:icon_alert_green_checkmark.png["녹색 확인 표시 아이콘"]. *상태* 열에 다음 아이콘 중 하나가 표시되면 문제를 해결해야 합니다.
+
[cols="1a,1a,3a"]
|===
| 아이콘을 클릭합니다 | 색상 | 심각도입니다 
 ...
 a| 
image:icon_alarm_yellow_notice.gif["노란색 사각형 아이콘"]
 a| 
노란색
 a| 
주의
 ...
 a| 
image:icon_alert_yellow_minor.png["연한 주황색 다이아몬드 아이콘"]
 a| 
연한 주황색
 a| 
경미합니다
 ...
 a| 
image:icon_alert_orange_major.png["진한 주황색 다이아몬드 아이콘"]
 a| 
진한 주황색
 a| 
전공
 ...
 a| 
image:icon_alert_red_critical.png["빨간색 x 아이콘"]
 a| 
빨간색
 a| 
심각

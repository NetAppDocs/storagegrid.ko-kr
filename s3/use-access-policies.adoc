...
summary: 'StorageGRID는 Amazon Web Services(AWS) 정책 언어를 사용하여 S3 테넌트가 버킷 및 해당 버킷 내의 객체에 대한 액세스를 제어할 수 있도록 합니다.' 
---
...
== [[use-putoverwriteobject-permission]]PutOverwriteObject 권한 사용

...
+
image:autosupport_santricity_home_page.png["AutoSupport SANtricity 홈 페이지"]
...
+
image:autosupport_santricity_operations.png["AutoSupport SANtricity AutoSupport 작업"]
...
+
image:autosupport_configure_delivery_santricity.png["AutoSupport AutoSupport 전송 방법 SANtricity를 구성합니다"]

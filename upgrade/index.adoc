...
* link:../release-notes/whats-new.html["StorageGRID 12.0의 새로운 기능"]
* link:../release-notes/removed-or-deprecated-features.html["제거되거나 사용되지 않는 기능"]
* link:../release-notes/changes-to-grid-management-api.html["Grid Management API 변경"]
* link:../release-notes/changes-to-tenant-management-api.html["테넌트 관리 API의 변경 사항"]

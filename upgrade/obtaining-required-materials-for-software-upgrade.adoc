...
---
= StorageGRID 소프트웨어 업그레이드에 필요한 자료를 확보하세요
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
StorageGRID 설명서
 a| 
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["릴리스 정보"^]. NetApp 계정으로 로그인하거나 계정을 생성하여 릴리스 노트에 액세스해야 합니다. 업그레이드를 시작하기 전에 이를 주의 깊게 읽어야 합니다.

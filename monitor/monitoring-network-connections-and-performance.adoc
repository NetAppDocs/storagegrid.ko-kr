...
+
image:nodes_page_network_traffic_graph.png["노드 페이지 네트워크 트래픽 그래프"]

+
.. 그리드 노드를 선택한 경우 아래로 스크롤하여 페이지의 * 네트워크 인터페이스 * 섹션을 검토합니다.
+
image:nodes_page_network_interfaces.png["노드 페이지 네트워크 인터페이스"]
...
+
image:nodes_page_network_communication.png["노드 페이지 네트워크 통신"]
...
+
image:traffic_classification_policies_main_screen_w_examples.png["그래프 트래픽 정책 예"]
...
+
image:nodes_page_hardware_tab_graphs.png["노드 페이지 하드웨어 탭"]
